    ...
    return (
      ...
      >
        ...
        <div className="relative">
          {open && (
            <CommandList
              className="h-56 absolute top-1 z-10 w-full rounded-md border bg-popover text-popover-foreground shadow-md outline-none animate-in"
              onMouseLeave={() => {
                        ...
                        {dropdowns.map((option) => {
                          return (
                            <CommandItem
                              ...
                              className={cn(
                                "cursor-pointer flex flex-col justify-start items-start",
                                option.disable &&
                                  "cursor-default text-muted-foreground"
                              )}
                            >
                              <span>{option.name}</span>{" "}
                              <span className="text-muted-foreground/80">{option.email}</span>
                            </CommandItem>
                          );
                        })}
                      </>
