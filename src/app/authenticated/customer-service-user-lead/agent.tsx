...
import { api_customer_service_agent_list } from "@/network/apis/customer-service/user_lead_api";

function CustomerServiceAgentPage() {
  ...
  const getData = async (skip: number) => {
    ...
    const r = await api_customer_service_agent_list({
      search: search,
      skip: skip,
      role: 1,
    });
...
export default CustomerServiceAgentPage;
