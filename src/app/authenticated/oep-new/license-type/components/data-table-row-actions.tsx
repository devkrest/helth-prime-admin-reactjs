...
import AddUpdateLicenseTypeDailog from "@/components/dailog/oep-new/add-update-license-type/add-update-license-type";
...
export function DataTableRowActions({
  row,
  getData,
}: DataTableRowActionsProps<ILicenseTypeModel>) {
