...
import AddUpdateAppointmentDailog from "@/components/dailog/oep-new/add-update-appointment/add-update-appointment";
...
export function DataTableRowActions({
  row,
  getData,
}: DataTableRowActionsProps<IAppointmentModel>) {
        ...
        >
          <DialogHeader>
            ...
            <DialogDescription className="text-start ">
              Are you sure, You want to delete this Appointment status ?
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="flex justify-end gap-x-3 ">
            ...
            <DialogClose asChild>
              <Button
                ...
                onClick={async () => {
                  setDeleteOpen(false);
                  await api_oep_appointment_add_update({
                    status: "-1",
                    id: row.original.id,
                  });
                  getData(0);
