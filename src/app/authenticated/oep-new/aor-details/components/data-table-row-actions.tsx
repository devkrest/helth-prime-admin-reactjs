...
import AddUpdateAorDetailsDailog from "@/components/dailog/oep-new/add-update-aor/add-update-aor-details";
...
export function DataTableRowActions({
  row,
  getData,
}: DataTableRowActionsProps<IAorNameModel>) {
        ...
        >
          <DialogHeader>
            ...
            <DialogDescription className="text-start ">
              Are you sure, You want to delete this AOR ?
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="flex justify-end gap-x-3 ">
            ...
            <DialogClose asChild>
              <Button
                ...
                onClick={async () => {
                  setDeleteOpen(false);
                  await api_oep_aor_name_add_update({
                    status: "-1",
                    id: row.original.id,
                  });
                  getData(0);
