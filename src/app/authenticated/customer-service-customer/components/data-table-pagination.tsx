...
export function DataTablePagination<TData>({
  ...
  return (
    <div className="flex items-center justify-between  sm:px-2 w-full mt-3">
      ...
      <div className="flex items-center space-x-6 lg:space-x-8">
        ...
        <div className="flex items-center space-x-2">
          ...
          <Button
            ...
            onClick={() => {
              table.nextPage();
              callToNextPage(table.getState().pagination.pageIndex + 1,table.getState().pagination.pageSize);
            }}
